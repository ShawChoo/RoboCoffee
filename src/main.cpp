/**
 *     RoboCoffee - MyMachine project, school year 2021/2022
 *     Device with build-in 4 games, after completing particular game a reward for that game is unlocked
 *     Meant to be used with Arduino Mega 2560 based boards or similar
 *
